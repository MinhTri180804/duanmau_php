                ...
                <div class="wrapper">
                    <div class="container_left">
                        <ul class="list_img-demo">
                            ...
                            <li class="list_img-demo-item">
                                <img src="<?php echo _WEB_ROOT; ?>public/img/img-product.webp" alt="">
                            </li>
                            <li class="list_img-demo-item">
                                <img src="<?php echo _WEB_ROOT; ?>public/img/id-000138a_b98adb50b4d844d6a09389b9ce816f7a_large.webp"
                                    alt="">
                            </li>
                    ...
                    <div class="container_right">
                        ...
                        <div class="product_code">
                            <span class="product_code-title">Mã sản phẩm : </span> <span class="code">ATID0275-01</span>
                        </div>
                        ...
                        <div class="product_color">
                            ...
                            <div class="product_color-demo">
                                <ul class="list_color">
                                    <li class="list_color-item active" value="Đen">
                                        <img src="<?php echo _WEB_ROOT; ?>public/img/id-000138a_b98adb50b4d844d6a09389b9ce816f7a_large.webp"
                                            alt="" class="color_img">
                                    </li>
                                    <li class="list_color-item" value="Trắng">
                                        <img src="<?php echo _WEB_ROOT; ?>public/img/id-000138a_b98adb50b4d844d6a09389b9ce816f7a_large.webp"
                                            alt="" class="color_img">
                                    </li>
                                </ul>
                        ...
                        <div class="product_size">
                            ...
                            <div class="product_size-demo">
                                <ul class="list_size">
                                    <li class="list_size-item active" value="S">
                                        S
                                    </li>
                                    <li class="list_size-item" value="M">
                                        M
                                    </li>
                                    <li class="list_size-item" value="L">
                                        L
                                    </li>
                                    <li class="list_size-item" value="XL">
                                        XL
                                    </li>
                                </ul>
                            </div>
